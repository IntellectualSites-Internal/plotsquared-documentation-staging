...
[TIP]
Also, you can assign xref:/permission-packs.adoc#_plots_permpack_basicflags[`plots.permpack.basicflags`] to cover the following permissions and lots of the basic flags.
